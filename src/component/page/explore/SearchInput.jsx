...
export default function SearchInput() {
    return (
        <div className="bg-slate-50 relative">
            <div className="mx-80 py-10 space-y-5">
                <div className="relative flex justify-between space-x-6">
                    <div className="relative w-4/6">
                        ...
                        <input type="text" id="input-group-1"
                               className="bg-white pl-16 border border-gray-200 p-10 text-md text-gray-500 rounded-3xl block w-full focus:outline-0 hover:bg-gray-100 focus:bg-gray-100"
                ...
                <div className="relative flex bg-white p-7 rounded-2xl space-x-6">
                    <div className="relative">
                        ...
                        <input type="text" id="input-group-1"
                               className="bg-white pl-12 border border-gray-200 p-4 text-sm text-gray-500 rounded-2xl block focus:outline-0 hover:bg-gray-100 focus:bg-gray-100"
                               placeholder="Company"/>
                    </div>
                    <div className="relative">
                        <div className="absolute inset-y-0 start-1 flex items-center ps-3.5 pointer-events-none">
